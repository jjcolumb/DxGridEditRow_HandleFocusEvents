...
using DxGridEditRow_HandleFocusEvents.Blazor.Server.Editors.ProductListViewEditor;

namespace DxGridEditRow_HandleFocusEvents.Blazor.Server;

[ToolboxItemFilter("Xaf.Platform.Blazor")]
// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class DxGridEditRow_HandleFocusEventsBlazorModule : ModuleBase {
    ...
    public DxGridEditRow_HandleFocusEventsBlazorModule() {
